...
<img src="design photo/<?php echo $row[6];?>" id="i1" style="width:200px; height:200px; border-radius:100px"><br><br>
<p style="margin-left:70px; color:white;"> <b><?php echo $row[1]?>;</b></p>
<input type="text" value="<?php echo $row[4]; ?>" style="width:50px; height:20px; margin-left:70px; border:none;" readonly></p><br><br>
</div>
