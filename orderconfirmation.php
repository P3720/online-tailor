...
<center><label class="lbl"><b>orderconfirmation</b></label></center>
...
<p class="p1">reccieve By</p>
<input type="text" placeholder="Reccieve By" name="txt5" id="txt5" class="form-control" required><br>

<p class="p1">confirm</p>
<select class="form-control" id="s2"><option></option><option value="yes">yes</option><option value="no">no</option></select><br>
<input type="button" value="ok" id="b1" class="btn-success" style="width:100px">
<input type="button" value="back" id="b2" class="btn-success" style="width:100px">
