...
<div class="col-md-12" style="background-color:rgb(64,09,128)" id="dvd1" name="n1">
<div class="row">
<div class="col-md-12">
...
<legend class="scheduler-border" style="width:150px; color:white;">Shuit Speciality</legend>
<?php
...
<div class="col-xs-4 "id="ddd2">
<img src="jqueryphoto/<?php echo $row[7];?>" id="i1" style="width:200px; height:200px;">
<p style="margin-left:40px; color:white"> <?php echo $row[0];?></p>
<a href="detail.php?a1=<?php echo $row[0];?> &tb=<?php echo $_REQUEST['tb'];?>" id="ancr">
<input type="button" value="view" style="margin-left:50px;" ></a><br><br>
</div>
