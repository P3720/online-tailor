 ...
 $(this).val( $(this).val().replace(/[^a-zA-Z0-9@#$%^&*]/g, function(str)
  ...
  alert('Enter only numberic $ character value and special character '); return '';
	...
	success:function(response){
		if(response!=0)
		{
			window.location.href="logn.php?a111="+uid+"&a2="+pass;
		}
		else
		{
...
<br><br><br>
<div class="container col-md-5 col-md-offset-3" style="background-color:rgb(64,0,64);" id="dd1">
<center><img src="profile1.png"class="img1">
<h4 style="color:white;">Login</h4></center>
<center><div style="width:200px; height:40px; background-color:red;visibility:hidden;" id="msg">
<label style="color:white;">user id and password not matched in database</label></div></center>
<p style="color:white;">Enter id</p>
<input type="text" class="form-control" id="a1" name="t1" >
<p style="color:white;">Enter password</p>
<input type="password" class="form-control"  name="t2"id="p1"><br>
<center><input type="button" value="submit" id="b1" class="btn-success btn-sm"></center>
