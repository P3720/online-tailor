...
<center><label class="lbl"><b>Cancel Order</b></label></center>
...
<center><input type="button" value="cancel" id="b1" class="btn-danger" style="width:100px"></center>
