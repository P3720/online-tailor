...
$("#sp9").click(function()
	...
	$('#txt1').keyup(function() 
	{
 $(this).val( $(this).val().replace(/[^a-zA-Z ]/g, function(str)
  { alert('Enter  character value '); return '';
   } ) );
...
//$("#s2").innrHTML="";
$("#s2").empty();
$("#s2").append('<option>select city</option>');
for(var i=0;i<x.length;i++)
{
	$("#s2").append('<option value="'+ x[i].ccode+'">'+x[i].cname+'</option>');
}	
...
<div class="container col-md-6" id="dd1" name="n1">

<fieldset class="scheduler-border" style="border:2px solid white; padding:0px 5px 5px 5px; border-top:2px solid white">
<legend class="scheduler-border" style="width:190px; color:white;"><b>Tailor Registration</b></legend>


<form action="registration1.php" method="post" enctype="multipart/form-data">

<p><b class="tn">Tailor Name</b></p>
<input type="text" placeholder="Name" name="txt1" id="txt1" class="form-control" required><br>

<p><b class="tn">Contact</b></p>
<input type="text" placeholder="Contact Number" name="txt2" id="txt2" class="form-control" required><br>
<p><b class="tn">Shop Name</b></p>
<input type="text" placeholder="Shop name" name="txt3" id="txt3" class="form-control" required><br>


<p><b class="tn">Address</b></p>
<textarea row="4" cols="50" placeholder="Address" name="txt4" id="txt4" class="form-control" required></textarea><br>

<p><b class="tn">State</b></p>
<?php 
...
<select class="form-control" name="s1" id="s1"><option required>select</option>
...
?>
<option value="<?php echo $row[0];?>" required>
<?php echo $row[1];?>
</option>
...
<p><b  class="tn">City</b></p>
<select class="form-control" name="s2" id="s2" required ></select>

<p><b class="tn">Pincode</b></p>
...
<div class="container col-md-6 " id="dd2" name="n2">
<fieldset class="scheduler-border" style="border:2px solid white; padding:0px 5px 5px 5px; border-top:2px solid white">
<legend class="scheduler-border" style="width:190px;color:white;"><b>Tailor Registration</b></legend>

<img id="uploadPreview" style="width: 100px; height: 100px;"src="tailor log.png">
<input id="uploadImage" type="file" name="myPhoto" style="visibility:hidden;" onchange="PreviewImage();"id="img"  />
<input type="button" value="browse" id="br1"  onclick="document.getElementById('uploadImage').click();" />

<p><b class="tn">sex</b></p>
<select class="form-control" name="s3"id="s3" required><option>male</option><option>female</option></select>

<p><b class="tn">Exprience</b></p>
<input type="text" placeholder="Expreance" name="txt5" id="txt5" class="form-control" required><br>

<p><b class="tn">Email Id</b></p>
<input type="text" placeholder="Email Id" name="txt6" id="txt6" class="form-control" required><br>

<input type="submit" value="Register" name="" id="b1" ><br>
