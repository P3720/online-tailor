...
{
	if(x[i].status=='1')
		$("#tab1").append('<tr><td>'+x[i].appointno+'</td><td style="padding-left:20px;">'+x[i].applieddate+'</td><td style="padding-left:20px;">pickup</td></tr>');
	//alert(x[i].name);
...
<fieldset class="scheduler-border" style="border:2px solid red; padding:0px 5px 5px 5px; border-top:2px solid blue">
<legend class="scheduler-border">pdf</legend>
<center><table><br>
<form action="pdfinvice1.php" method="post">
<tr><td><p>Appointment</p></td><td><input type="text" name="txt1" placeholder="appointno"id="txt1" class="form-control"></td>
<td><input type="submit" value="view" id="b1"></td></tr>
</table></center>
